...
echo "<html>\n<head>\n";
echo "<title>" . _MD_EDITO_COMEFROM . " " . $xoopsConfig ["sitename"] . "</title>\n";
...
echo "<body bgcolor='#ffffff' text='#000000' onload='window.print()'>
      ...
      <font size='1'>
      " . _MD_EDITO_COMEFROM . $xoopsConfig ["sitename"] ." : " . XOOPS_URL . "/modules/".$xoopsModule->dirname()."/content.php?id={$id}<br>
      " . $username . " " . $date . "
      </font></div>
      </div>";
echo "</body>
