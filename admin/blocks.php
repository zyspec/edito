...
require_once __DIR__ . '/blocks/mygrouppermform.php';
require_once XOOPS_ROOT_PATH . '/class/xoopsblock.php';
require_once __DIR__ . "/blocks/gtickets.php"; // GIJ ticketing
...
//		$sseln = $ssel0 = $ssel1 = $ssel2 = $ssel3 = $ssel4 = "Green";
//		$scoln = $scol0 = $scol1 = $scol2 = $scol3 = $scol4 = "transparent";
...
/** add for xoops 2.0.14 */
		...
		if( $can_clone ) {
			$clone_link = "<br /><a href='blocks/admin.php?fct=blocksadmin&amp;op=clone&amp;bid=$bid'>"._CLONE."</a>" ;
		} else {
			$clone_link = '' ;
		}
...
function list_groups()
{
	...
	echo "<h4 style='text-align:left;'>"._MD_AM_ADGS."</h4>\n" ;
...
if( ! empty( $_POST['submit'] ) ) {
	...
	include( "blocks/mygroupperm.php" ) ;
	redirect_header( XOOPS_URL."/modules/".$xoopsModule->dirname()."/admin/blocks.php" , 1 , _MD_AM_DBUPDATED );
}

include_once("admin_header.php");
edito_adminmenu(3, _MD_EDITO_NAV_BLOCKS_GROUPS);
