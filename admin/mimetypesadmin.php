...
switch($op) {
	...
	xoops_confirm( array( 'op' => 'dele', 'mperm_id' => $mperm_id, 'mime_id' => $mime_id, 'confirm' => 1, 'mime_name' => $mime_name , 'mod_name' => $mod_name , 'status' => $status, 'mid' =>$mid), 'mimetypes.php?', _AM_XI_MIME_DELETETHIS . "<br /><br /><font color='#CC0000'>" . $mod_name . "</font><br />" . $mime_name, _AM_XI_MIME_DELE );
	break;
