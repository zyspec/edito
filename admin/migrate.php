...
/** @var Edito\Common\Configurator $configurator */
$configurator = new Edito\Common\Configurator();

/** @var \XoopsModules\Edito\Common\Migrate $migrator */
$migrator = new \XoopsModules\Edito\Common\Migrate($configurator);
