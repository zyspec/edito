...
function select($table='')
{
	...
	// DB feed
	$sform = new XoopsThemeForm( _AM_EDITO_DB_EXPORT, "op", xoops_getenv( 'PHP_SELF' ) );
...
*/
    ...
    $export_radio = new XoopsFormRadio(_AM_EDITO_TYPE, 'op', $op);
    $export_radio->addOption('database_export_insert', _AM_EDITO_INSERT.'<br />');
