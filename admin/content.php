...
function editarticle($id = '', $op = '')
{
    ...
    //require_once XOOPS_ROOT_PATH .'/modules/edito/include/functions.php';
    ...
    if (!isset($media_url)) {
        ...
        $media_url = (int)$media_url;
    }

    if (!isset($media_file)) {
        $media_file = '';
    } else {
        $media_file = (int)$media;
    }
