...
//		$myts = MyTextSanitizer::getInstance();
        ...
        $sform = new XoopsThemeForm( _AM_EDITO_MODEDITO . ": ". $subject . $block_help, "op", xoops_getenv( 'PHP_SELF' ) );
...
// Misc data
	...
	// This part is common to edit/add
        ...
        //@todo $block_help_out is undefined - figure out what it's suppose to be
...
//	$media_tray -> addElement( new XoopsFormLabel( "", "<br /><br /><img src='".XOOPS_URL . "/". $xoopsModuleConfig['sbmediadir'] ."/" . $display_media . "' name='media5' id='media5' alt='" . $media_file . "' />" ) );
	...
	$media_s_array = array( 'default'			=> _AM_EDITO_SELECT_DEFAULT,
...
*/
        ...
        /* --------------------------------------------------------------------	*/
		/* 					Traitement des images et des m�dias					*/
        /* --------------------------------------------------------------------	*/
...
*/
	...
	case "del":
        ...
        xoops_confirm( array( 'op' => 'del', 'id' => $id, 'confirm' => 1, 'subject' => $subject ), 'content.php', _AM_EDITO_DELETETHIS . "<br /><br>" . $myts->displayTarea($subject), _AM_EDITO_DELETE );
