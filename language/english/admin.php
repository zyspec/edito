...
// define('_MD_EDITO_CANTPARENT', "Une page m�re ne peut se lier � elle-m�me ou � sa fille !");
...
define('_MD_EDITO_UPLOAD', "Upload a media");
