...
define("_MB_EDITO_SUMMARY",		"R�sum�");
...
define("_MB_EDITO_SELECT_LATEST",		"- Le plus r�cent");
define("_MB_EDITO_SELECT_POP",			"- Le plus lu");
define("_MB_EDITO_SELECT_LINKED",		"- Li� � la page");
// myPinup - Added 27/09/04
define("_MB_EDITO_SELECT_DAY",			"- Chaque jours de l'ann�e");
define("_MB_EDITO_SELECT_WEEK",			"- Chaque semaine de l'ann�e");
define("_MB_EDITO_SELECT_WEEKDAY",	        "- Chaque jour de la semaine");
//
define("_MB_EDITO_SELECT_NONE",			"- -----------");
define("_MB_EDITO_SHOWTITLE",		"[TEXT] Afficher le titre");
define("_MB_EDITO_SHOWLOGO",		"[TEXT] Afficher le logo/media");


// Media - Added 14/06/2006
define("_MB_EDITO_MEDIA_DISPLAY",	"[MEDIA] Affichage du media");
