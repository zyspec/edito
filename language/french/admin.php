...
<ul><ol>
    ...
    <li><img src='../images/icon/hidden.gif' align='absmiddle' /> <b>Cacher :</b> Affichage de la page ind�pendamment de toute information relative au module.
	La page n'est pas reprise dans les indexes du module, ni dans le bloc de menu.</li>
	<li><img src='../images/icon/offline.gif' align='absmiddle' /> <b>D�sactiver :</b> La page est totalement innaccessible.</li>
	...
	<li><img src='../images/icon/php.gif' align='absmiddle' /> <b>Mode php :</b> Interpr�te le contenu de la page comme du code php.</li>
</ol></ul><ul>
...
<img src='../images/icon/tip.gif' align='absleft' /><b>Balises sp�ciales</b> : les balises suivantes peuvent �tre utilis�es dans le texte :
<ul><ol>
