...
define('_MD_EDITO_DOWNLOAD', 'T�l�charger le fichier !');

// admin links
define('_MD_EDITO_ONLINE', 'Activ�');
define('_MD_EDITO_OFFLINE', 'D�sactiv�');
define('_MD_EDITO_HTML', 'Mode html');
define('_MD_EDITO_PHP', 'Mode php');
define('_MD_EDITO_WAITING', 'En attente');
define('_MD_EDITO_ADD', 'Cr�er');
define('_MD_EDITO_EDIT', 'Editer');
define('_MD_EDITO_DELETE', 'Effacer');
define('_MD_EDITO_SETTINGS', 'Pr�f�rences');
define('_MD_EDITO_UTILITIES', 'Utilitaires');
define('_MD_EDITO_HIDDEN', 'Masqu�');
...
define('_MD_EDITO_MEDIA', 'URL du m�dia');
...
define('_MD_EDITO_SUBMITEXT', 'Compl�tez le formulaire suivant pour proposer une nouvelle page.');
