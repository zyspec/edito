...
//    'sub'                 => [
//        [
//            'name' => _MI_EDITO_VIEW_SEARCH,
//            'url'  => 'index.php',
//        ],
//    ],

    // ------------------- Install/Update -------------------
    'onInstall'           => 'include/edito_install.php',
    'onUpdate'            => 'include/edito_update.php',
    'onUninstall'         => 'include/edito_uninstall.php',
    // -------------------  PayPal ---------------------------
    'paypal'              => [
...
$modversion['templates'] = [
    ['file' => 'edito_head.tpl', 'description' => ''],
    ['file' => 'edito_foot.tpl', 'description' => ''],
    // Index templates
    ['file' => 'edito_index.tpl', 'description' => ''],
    ['file' => 'edito_index_ext.tpl', 'description' => ''],
    ['file' => 'edito_index_news.tpl', 'description' => ''],
    ['file' => 'edito_index_blog.tpl', 'description' => ''],
    // Pages templates
    ['file' => 'edito_content_index.tpl', 'description' => ''],
    ['file' => 'edito_content_item.tpl', 'description' => ''],
    ['file' => 'edito_content_html.tpl', 'description' => ''],
    ['file' => 'edito_content_php.tpl', 'description' => ''],
    // Content blocks templates
    ['file' => 'edito_block_content.tpl', 'description' => ''],
    // Menu blocks templates
    ['file' => 'edito_block_menu.tpl', 'description' => ''],
    ['file' => 'edito_block_image.tpl', 'description' => ''],
    ['file' => 'edito_block_list.tpl', 'description' => ''],
    ['file' => 'edito_block_ext.tpl', 'description' => ''],
    // Submit templates
    ['file' => 'edito_content_submit.tpl', 'description' => ''],
];
